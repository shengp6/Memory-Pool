...
public class DLList<E> implements Iterable<E> {
    ...
    public Iterator<E> reverseIterator() {
        return new RDLListIterator();
    }
    /**
     * The inner iterator class
     * @author Sheng Peng <shengp6>
     * @version 11/06/2015
     *
     */
        ...
        public E next() {
            if (hasNext())
            {
                ...
                throw new NoSuchElementException("Illegal call to "
                        + "next(); iterator is after end of it.");
            }
        }
        /**
    ...
    /**
     * The iterator in reverse direction
     * @author Sheng Peng <shengp6>
     * @version 11/07/2015
     *
     */
    private class RDLListIterator implements Iterator<E>
    {
        private Node<E> previousNode;
        private boolean wasNextCalled;
        /**
         * Constructor of RDLListIterator
         */
        private RDLListIterator()
        {
            previousNode = tail;
            wasNextCalled = false;
        }
        /**
         * Test if there is any more element
         * @return Returns true if the list iterator has more 
         * elements when traversing the list in the revere 
         * direction
         */
        @Override
        public boolean hasNext() {
         ...
         * set the wasNextCalled to be true
        ...
        /**
         * remove from the list the last element that was returned by 
         * next()
         * @throws IllegalStateException
         *             if next has not been called yet
         * @throws IllegalStateException
        ...
        public void remove()
        {
            if (wasNextCalled)
            {
                previousNode.previous().setNext(previousNode.next());
                previousNode.next().setPrevious(previousNode.previous());
                wasNextCalled = false;
                size--;
            }
            else {
